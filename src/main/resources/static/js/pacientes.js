...
async function cargarPaciente(){
  ...
  for(let Paciente of pacientes){
    ...
    let pacienteHtml  =  '<tr><td>'+Paciente.id+'</td><td>'+ Paciente.tipoDocumentoId +'</td><td>'+ Paciente.numeroDocumento
                        ...
                        +'</td><td>'+Paciente.firstLastName +'</td><td>'+Paciente.secondLastName+'</td><td>'+Paciente.municipios[0].genero+'</td><td>'+Paciente.departamentos[0].departamento+'</td><td>'+Paciente.municipios[0].name+'</td><td>'+botonEliminar+'</td></tr>';
